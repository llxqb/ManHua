 ...
 */
@PerActivity
@Component(dependencies = AppComponent.class, modules = {MoreCommentModule.class, ActivityModule.class})
public interface MoreCommentComponent extends ActivityComponent {
