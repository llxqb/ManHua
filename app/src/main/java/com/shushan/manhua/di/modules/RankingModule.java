...
import com.shushan.manhua.mvp.ui.activity.book.RankingControl;
import com.shushan.manhua.mvp.ui.activity.book.RankingPresenterImpl;
...
public class RankingModule {
    ...
    private RankingControl.RankingView view;

    public RankingModule(AppCompatActivity activity, RankingControl.RankingView view) {
        this.activity = activity;
        this.view = view;
    }

    public RankingModule(AppCompatActivity activity) {
        this.activity = activity;
    }
    ...
    @Provides
    @PerActivity
    RankingControl.RankingView view() {
        return this.view;
    }

    @Provides
    @PerActivity
    RankingControl.PresenterRanking providePresenterRanking(RankingPresenterImpl rankingPresenter) {
