 ...
 */
@PerActivity
@Component(dependencies = AppComponent.class, modules = {LongDeleteModule.class, ActivityModule.class})
public interface LongDeleteComponent extends ActivityComponent {
    //对LoginActivity进行依赖注入
    void inject(LongDeleteActivity activity);
