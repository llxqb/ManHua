 ...
 */
@PerActivity
@Component(dependencies = AppComponent.class, modules = {ReadingHistoryModule.class, ActivityModule.class})
public interface ReadingHistoryComponent extends ActivityComponent {
    //对LoginActivity进行依赖注入
    void inject(ReadingHistoryActivity activity);
