 ...
 */
@PerActivity
@Component(dependencies = AppComponent.class, modules = {BookClassificationModule.class, ActivityModule.class})
public interface BookClassificationComponent extends ActivityComponent {
    //对LoginActivity进行依赖注入
    void inject(BookClassificationActivity activity);
