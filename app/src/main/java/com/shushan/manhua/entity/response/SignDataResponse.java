...
public class SignDataResponse {
     ...
     * continuous_day : 0
     * user_today_sign : 0
     * quest : [{"quest_id":1,"quest_name":"阅读3话漫画","bean":3,"icon":"https://img.pulaukomik.com/icon/quest1.png","num":0,"status":1},{"quest_id":2,"quest_name":"评论1部漫画","bean":3,"icon":"https://img.pulaukomik.com/icon/quest2.png","status":1},{"quest_id":3,"quest_name":"加入书架一部漫画","bean":3,"icon":"https://img.pulaukomik.com/icon/quest3.png","status":1},{"quest_id":4,"quest_name":"分享给好友","bean":3,"icon":"https://img.pulaukomik.com/icon/quest4.png","status":1}]
    ...
    public static class QuestBean {
         ...
         * quest_name : 阅读3话漫画
         * bean : 3
         * icon : https://img.pulaukomik.com/icon/quest1.png
         * num : 0
         * status : 1
         */
