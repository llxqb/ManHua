 ...
 * 书架adapter
 */
public class BookShelfDeleteAdapter extends BaseQuickAdapter<BookShelfResponse, BaseViewHolder> {

    public BookShelfDeleteAdapter(@Nullable List<BookShelfResponse> data) {
