 ...
 * @author li.liu
 */
public class ReadBookViewDialog extends BaseDialogFragment {
    public static final String TAG = ReadBookViewDialog.class.getSimpleName();
    @BindView(R.id.text_tv)
    TextView mTextTv;
    Unbinder unbinder;
    private String name;

    public static ReadBookViewDialog newInstance() {
        return new ReadBookViewDialog();
    }
