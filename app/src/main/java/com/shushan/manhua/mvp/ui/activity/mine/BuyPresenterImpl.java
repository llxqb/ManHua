...
//        Disposable disposable = mMineModel.onRequestLogin(loginRequest).compose(mBuyView.applySchedulers()).retryWhen(new com.shushan.homework101.help.RetryWithDelay(3, 3000))
//                .subscribe(this::requestLoginSuccess, throwable -> mBuyView.showErrMessage(throwable),
...
//                mBuyView.getLoginSuccess(response);
//            }
//        } else {
