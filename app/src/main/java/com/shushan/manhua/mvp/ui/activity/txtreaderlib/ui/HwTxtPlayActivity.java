package com.shushan.manhua.mvp.ui.activity.txtreaderlib.ui;
...
//        mProgressText = (TextView) findViewById(R.id.activity_hwtxtplay_progress_text);
        ...
        mPreChapterTv = findViewById(R.id.pre_chapter_tv);
        mNextChapterTv = findViewById(R.id.next_chapter_tv);
        mDirectoryTv = findViewById(R.id.directory_tv);
        mReadModelTv = findViewById(R.id.read_model_tv);
    ...
    private void setExtraListener() {
        mPreChapterTv.setOnClickListener(new ChapterChangeClickListener(true));
        mNextChapterTv.setOnClickListener(new ChapterChangeClickListener(false));
...
//                mProgressText.setText(((float) p / 10) + "%");
    ...
    protected void setMenuListener() {
        ...
        mChapterMenuText.setOnClickListener(view -> {
        ...
        mDirectoryTv.setOnClickListener(view -> {
            if (mChapterListPop != null) {
                if (!mChapterListPop.isShowing()) {
                    mChapterListPop.showAsDropDown(mTopDecoration);
                    mHandler.postDelayed(new Runnable() {
