 ...
 * 浏览历史adapter
 */
public class ReadingHistoryAdapter extends BaseQuickAdapter<ReadingHistoryResponse, BaseViewHolder> {

    public ReadingHistoryAdapter(@Nullable List<ReadingHistoryResponse> data) {
        super(R.layout.item_reading_history, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, ReadingHistoryResponse item) {
