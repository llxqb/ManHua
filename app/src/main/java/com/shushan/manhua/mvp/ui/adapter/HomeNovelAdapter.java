 ...
 * 首页小说adapter
 */
public class HomeNovelAdapter extends BaseQuickAdapter<HomeResponse.HomeCommonBean, BaseViewHolder> {

    private ImageLoaderHelper mImageLoaderHelper;

    public HomeNovelAdapter(@Nullable List<HomeResponse.HomeCommonBean> data, ImageLoaderHelper imageLoaderHelper) {
        super(R.layout.item_home_novel, data);
        mImageLoaderHelper = imageLoaderHelper;
    }

    @Override
    protected void convert(BaseViewHolder helper, HomeResponse.HomeCommonBean item) {
        helper.addOnClickListener(R.id.item_home_novel_layout);
