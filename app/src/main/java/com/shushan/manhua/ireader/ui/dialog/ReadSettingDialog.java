package com.shushan.manhua.ireader.ui.dialog;
...
import com.shushan.manhua.ireader.ui.adapter.PageStyleAdapter;
...
import com.shushan.manhua.ireader.widget.page.PageMode;
import com.shushan.manhua.ireader.widget.page.PageStyle;
...
public class ReadSettingDialog extends Dialog {
    ...
    private void initWidget() {
        ...
        if (isBrightnessAuto) {
            mCbBrightnessAuto.setCompoundDrawablesWithIntrinsicBounds(getDrawable(R.mipmap.novel_settings_oval_choose), null, null, null);
        } else {
            mCbBrightnessAuto.setCompoundDrawablesWithIntrinsicBounds(getDrawable(R.mipmap.novel_settings_oval), null, null, null);
        }
