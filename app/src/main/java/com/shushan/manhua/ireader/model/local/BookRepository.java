...
import com.shushan.manhua.ireader.model.bean.BookRecordBean;
import com.shushan.manhua.ireader.model.bean.ChapterInfoBean;
import com.shushan.manhua.ireader.model.bean.CollBookBean;
import com.shushan.manhua.ireader.model.gen.BookChapterBeanDao;
import com.shushan.manhua.ireader.model.gen.BookRecordBeanDao;
import com.shushan.manhua.ireader.model.gen.CollBookBeanDao;
import com.shushan.manhua.ireader.model.gen.DaoSession;
import com.shushan.manhua.ireader.model.gen.DownloadTaskBeanDao;
import com.shushan.manhua.ireader.utils.BookManager;
import com.shushan.manhua.ireader.utils.Constant;
import com.shushan.manhua.ireader.utils.FileUtils;
import com.shushan.manhua.ireader.utils.IOUtils;
...
public class BookRepository {
     ...
     * 根据章节id查询章节内容
     */
    public Single<BookChapterBean> getBookRecordByChapterId(String chapterId){
        return Single.create(new SingleOnSubscribe<BookChapterBean>() {
            @Override
            public void subscribe(SingleEmitter<BookChapterBean> e) throws Exception {
                BookChapterBean beans = mSession
                        .getBookChapterBeanDao()
                        .queryBuilder()
                        .where(BookChapterBeanDao.Properties.BookId.eq(chapterId))
                        .unique();
                e.onSuccess(beans);
            }
        });
