package com.shushan.manhua.ireader.ui.adapter.view;
...
import com.shushan.manhua.ireader.ui.base.adapter.ViewHolderImpl;
...
public class CategoryHolder extends ViewHolderImpl<TxtChapter> {
    ...
    public void onBind(TxtChapter value, int pos){
        ...
        //如果没有链接地址表示是本地文件
        if(value.isUnreadble()){//true 收费  false 免费
             drawable = getContext().getResources().getDrawable(R.mipmap.lock_book);
        }else {
