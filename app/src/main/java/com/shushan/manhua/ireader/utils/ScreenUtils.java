package com.shushan.manhua.ireader.utils;
...
public class ScreenUtils {
    ...
    public static int getStatusBarHeight(){
        Resources resources = ManHuaApplication.getContext().getResources();
    ...
    public static int getNavigationBarHeight() {
        ...
        Resources rs = ManHuaApplication.getContext().getResources();
    ...
    public static DisplayMetrics getDisplayMetrics(){
        DisplayMetrics metrics = ManHuaApplication
                .getContext()
                .getResources()
                .getDisplayMetrics();
        return metrics;
